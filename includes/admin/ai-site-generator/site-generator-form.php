<?php
/**
 * Site Wizard form panel (UI v3).
 *
 * Ported from design_handoff_ui_v3/preview/wizard-stepper.html,
 * preview/form-fields.html, preview/panel.html, preview/notices.html.
 *
...
function contai_render_full_site_generator_form() {
	...
	<div class="contai-stepper" aria-label="<?php esc_attr_e( 'Site setup steps', '1platform-content-ai' ); ?>">
		<div class="contai-step is-active">
			<div class="contai-step-dot">1</div>
			<div class="contai-step-label"><?php esc_html_e( 'Identity', '1platform-content-ai' ); ?></div>
		</div>
		<div class="contai-step">
			<div class="contai-step-dot">2</div>
			<div class="contai-step-label"><?php esc_html_e( 'Legal', '1platform-content-ai' ); ?></div>
		</div>
		<div class="contai-step">
			<div class="contai-step-dot">3</div>
			<div class="contai-step-label"><?php esc_html_e( 'Content', '1platform-content-ai' ); ?></div>
		</div>
	</div>
	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin.php?page=contai-ai-site-generator' ) ); ?>" class="contai-site-generator-form">
		...
		<div class="contai-panel" data-step="1">
			<div class="contai-panel-head">
				<div class="contai-panel-head-main">
					...
					<div>
						<h2 class="contai-panel-title"><?php esc_html_e( 'Website Identity', '1platform-content-ai' ); ?></h2>
						<p class="contai-panel-desc"><?php esc_html_e( 'Define what your website is about and who it targets.', '1platform-content-ai' ); ?></p>
					</div>
				</div>
				<span class="contai-field-state"><?php esc_html_e( 'Step 1 of 3', '1platform-content-ai' ); ?></span>
			</div>
			<div class="contai-panel-body">
				<div class="contai-form-grid">
					<div class="contai-field contai-form-grid-full">
						...
						<input type="text" id="contai_site_topic" name="contai_site_topic" class="contai-input"
							value="<?php echo esc_attr( $post( 'contai_site_topic' ) ); ?>"
							placeholder="<?php esc_attr_e( 'e.g., Indoor gardening, Personal finance, Pet care...', '1platform-content-ai' ); ?>"
							autocomplete="off" required>
						<p class="contai-field-help">
							<span class="dashicons dashicons-info" aria-hidden="true"></span>
							<?php esc_html_e( 'The main subject of your website.', '1platform-content-ai' ); ?>
						</p>
					</div>
					...
					<div class="contai-field">
						...
						?>
						<select id="contai_site_category" name="contai_site_category" class="contai-select"
							autocomplete="off" required data-lang-select="#contai_site_language">
							...
							<?php else : ?>
								...
								<?php foreach ( $categories as $category ) : ?>
									...
									?>
									<option value="<?php echo esc_attr( $category_id ); ?>"<?php selected( $is_selected ); ?>
										data-title-en="<?php echo esc_attr( $title_en ); ?>"
										data-title-es="<?php echo esc_attr( $title_es ); ?>"
										data-theme="<?php echo esc_attr( $category_theme ); ?>">
						...
						<p class="contai-field-help">
							<span class="dashicons dashicons-info" aria-hidden="true"></span>
							<?php esc_html_e( 'Determines the theme and content style.', '1platform-content-ai' ); ?>
						</p>
					</div>
					...
					<div class="contai-field">
						...
						<select id="contai_site_language" name="contai_site_language" class="contai-select"
							autocomplete="language" required data-category-select="#contai_site_category">
					...
					<div class="contai-field">
						...
						<select id="contai_target_country" name="contai_target_country" class="contai-select"
					...
					<div class="contai-field contai-form-grid-full">
						...
						<p class="contai-field-help">
							<span class="dashicons dashicons-info" aria-hidden="true"></span>
							<?php esc_html_e( 'Account > Account information in AdSense. Leave empty if you do not have an AdSense account yet.', '1platform-content-ai' ); ?>
						</p>
					</div>
				</div>
			</div>
		...
		<div class="contai-panel" data-step="2">
			<div class="contai-panel-head">
				<div class="contai-panel-head-main">
					<div class="contai-tile" aria-hidden="true">
					...
					<div>
						<h2 class="contai-panel-title"><?php esc_html_e( 'Legal Information', '1platform-content-ai' ); ?></h2>
						<p class="contai-panel-desc"><?php esc_html_e( 'Used to generate privacy policy, terms of service, and cookie consent.', '1platform-content-ai' ); ?></p>
					</div>
				</div>
				<span class="contai-field-state"><?php esc_html_e( 'Step 2 of 3', '1platform-content-ai' ); ?></span>
			</div>
			<div class="contai-panel-body">
				<div class="contai-form-grid">
					<div class="contai-field">
						...
						<input type="text" id="contai_legal_owner" name="contai_legal_owner" class="contai-input"
							value="<?php echo esc_attr( $post( 'contai_legal_owner' ) ); ?>"
							placeholder="<?php esc_attr_e( 'John Doe', '1platform-content-ai' ); ?>"
					...
					<div class="contai-field">
						...
						<input type="email" id="contai_legal_email" name="contai_legal_email" class="contai-input"
							value="<?php echo esc_attr( $post( 'contai_legal_email', $default_email ) ); ?>"
							placeholder="<?php esc_attr_e( 'info@domain.com', '1platform-content-ai' ); ?>"
					...
					<div class="contai-field">
						...
						<input type="text" id="contai_legal_activity" name="contai_legal_activity" class="contai-input"
							value="<?php echo esc_attr( $post( 'contai_legal_activity' ) ); ?>"
							placeholder="<?php esc_attr_e( 'e.g., Digital publishing', '1platform-content-ai' ); ?>"
					...
					<div class="contai-field">
						...
						<input type="text" id="contai_legal_address" name="contai_legal_address" class="contai-input"
							value="<?php echo esc_attr( $post( 'contai_legal_address' ) ); ?>"
							placeholder="<?php esc_attr_e( '123 Main St, City, Country', '1platform-content-ai' ); ?>"
		...
		<div class="contai-panel" data-step="3">
			<div class="contai-panel-head">
				<div class="contai-panel-head-main">
					<div class="contai-tile" aria-hidden="true">
					...
					<div>
						<h2 class="contai-panel-title"><?php esc_html_e( 'Content Generation', '1platform-content-ai' ); ?></h2>
						<p class="contai-panel-desc"><?php esc_html_e( 'Configure how AI generates your website content, keywords, and images.', '1platform-content-ai' ); ?></p>
					</div>
				</div>
				<span class="contai-field-state"><?php esc_html_e( 'Step 3 of 3', '1platform-content-ai' ); ?></span>
			</div>
			<div class="contai-panel-body">
				<div class="contai-form-grid">
					<div class="contai-field contai-form-grid-full">
						...
						<input type="text" id="contai_source_topic" name="contai_source_topic" class="contai-input"
							value="<?php echo esc_attr( $post( 'contai_source_topic' ) ); ?>"
							placeholder="<?php esc_attr_e( 'e.g., indoor plants care, home workout routines...', '1platform-content-ai' ); ?>"
							autocomplete="off" spellcheck="false" required>
						<p class="contai-field-help">
							<span class="dashicons dashicons-info" aria-hidden="true"></span>
							<?php esc_html_e( 'We\'ll research this topic to extract relevant keywords for your content.', '1platform-content-ai' ); ?>
						</p>
					</div>
					...
					<div class="contai-field">
						...
						<input type="number" id="contai_num_posts" name="contai_num_posts" class="contai-input"
							value="<?php echo esc_attr( $post( 'contai_num_posts', '100' ) ); ?>"
							min="1" max="1000" autocomplete="off" required>
					</div>
					...
					<div class="contai-field">
						...
						<input type="number" id="contai_comments_per_post" name="contai_comments_per_post" class="contai-input"
							value="<?php echo esc_attr( $post( 'contai_comments_per_post', '1' ) ); ?>"
							min="1" max="10" autocomplete="off" required>
					</div>
					...
					<div class="contai-field contai-form-grid-full">
						...
						<select id="contai_image_provider" name="contai_image_provider" class="contai-select"
							autocomplete="off" required>
			...
			<div class="contai-panel-foot">
				<span class="contai-panel-foot-meta">
					...
					<?php esc_html_e( 'Generation runs in the background. You can safely close this page and check progress later.', '1platform-content-ai' ); ?>
				</span>
				<div class="contai-panel-foot-actions">
					<button type="submit" id="contai_submit_btn"
						class="contai-btn contai-btn-primary contai-btn-lg"
						<?php echo ! $creditCheck['has_credits'] ? 'disabled' : ''; ?>>
