<?php
/**
 * Jobs admin panel — UI v3 renderer.
 *
...
if ( ! class_exists( 'ContaiAdminJobMonitorV3' ) ) {

	class ContaiAdminJobMonitorV3 {
		...
		private function renderPage(): void {
			...
			?>
			<div class="<?php echo esc_attr( ContaiJobMonitorPanel::wrapperClass() ); ?>" data-screen-label="job-monitor">
