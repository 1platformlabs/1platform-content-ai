...
= 3.2.1 =
* Security: the bundled app key is documented as a public distribution identifier, and development no longer ships the QA key (#205)

= 3.2.0 =
* Added: E1 — inventory publish, order polling, actions (WPG-02/03/04/05/06/08/10) (#186)
